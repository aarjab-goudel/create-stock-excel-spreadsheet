...
def cleanISObj(isObj):
    isObj.revenue = cleanRowValues(isObj.revenue)    
    isObj.costOfRevenue = cleanRowValues(isObj.costOfRevenue)
    isObj.grossProfit = cleanRowValues(isObj.grossProfit)
    isObj.operatingIncome = cleanRowValues(isObj.operatingIncome)
    isObj.netIncome = cleanRowValues(isObj.netIncome)
    isObj.researchAndDevelopment = cleanRowValues(isObj.researchAndDevelopment)            
...
def readAnnualISDataForTicker(ticker):
    ...
    isObj.researchAndDevelopment = getRowValuesByText(r_and_d_soup, 'Research & Development', 'span')['Research & Development']
